...
dat_file_tmp = './news_articles/express_news-uk_tmp.txt'
dat_file = './news_articles/express_news-uk.txt'

open(dat_file_tmp, 'w').close()

url = 'https://www.express.co.uk/news/uk'
print('searching', url)
...
for link in soup.find_all('a'):
    href = link.get('href')
    if href is not None and href.startswith('/news/uk') and \
            href != '/entertainment/uk':
