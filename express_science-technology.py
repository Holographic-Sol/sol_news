...
dat_file_tmp = './news_articles/express_science-technology_tmp.txt'
dat_file = './news_articles/express_science-technology.txt'

open(dat_file_tmp, 'w').close()

url = 'https://www.express.co.uk/life-style/science-technology'
print('searching', url)
...
for link in soup.find_all('a'):
    href = link.get('href')
    if href is not None and href.startswith('/life-style/science-technology/') and \
            href != '/entertainment/science-technology':
