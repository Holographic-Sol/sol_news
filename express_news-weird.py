...
dat_file_tmp = './news_articles/express_news-weird_tmp.txt'
dat_file = './news_articles/express_news-weird.txt'
...
for link in soup.find_all('a'):
    href = link.get('href')
    if href is not None and href.startswith('/news/weird') and \
            href != '/entertainment/weird':
